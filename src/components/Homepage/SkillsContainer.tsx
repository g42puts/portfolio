...
export default function SkillsContainer({ h4Text, Items }: { h4Text: string, Items: ITools[] }) {
  return (
    <div className="flex flex-col sm:p-5 p-4 justify-center gap-10 max-w-[1100px] m-auto">
